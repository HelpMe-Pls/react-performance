...
## 📝 What I've learnt
- Use `React.Profiler` [to ensure](https://github.com/HelpMe-Pls/react-performance/blob/master/src/final/TS/07.tsx) that we always ship fast experiences to our users.
- Use the *experimental* `trace` API to [record user's interactions](https://github.com/HelpMe-Pls/react-performance/blob/master/src/final/TS/07.extra-1.tsx) on a component within a <React.Profiler />
