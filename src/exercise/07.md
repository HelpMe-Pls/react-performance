...
## 📝 What I've learnt
- Use `React.Profiler` [to ensure](https://github.com/HelpMe-Pls/react-performance/blob/master/src/final/07.js) that we always ship fast experiences to our users.
- Use the *experimental* `trace` API to [record user's interactions](https://github.com/HelpMe-Pls/react-performance/blob/master/src/final/07.extra-1.js) on a component within a <React.Profiler />
