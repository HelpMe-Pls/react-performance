...
## 📝 What I've learnt
- If your context `value` changes frequently, a quick way to improve performance is to [memoize it](https://github.com/HelpMe-Pls/react-performance/blob/master/src/final/TS/05.tsx) with `React.useMemo`.
- A better alternative is to [separate](https://github.com/HelpMe-Pls/react-performance/blob/master/src/final/TS/05.extra-1.tsx) the state and the mechanism for updating that state into two separate contexts (at line `71-72`).
